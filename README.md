...
<br>
<p>
       <strong>1.</strong> Unique Palindrome Problem
</p>
<p>
        <strong>2.</strong> Write a program to return all permutation from the given string of length 3. ( O(n!) complexity considered.)
</p>
